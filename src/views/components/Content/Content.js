...
import imageThreeNew from '../../../img/image3-3.png';
...
const printContent = [
    ...
    {
        heading: 'h2',
        title: 'Brother MFCL9550CDWT Беспроводное цветное лазерное\u00A0МФУ',
        image: imageThreeNew,
        description: 'Профессиональное цветное МФУ для больших рабочих групп',
        listTypes: [
            {printType: 'Автоматическая двусторонняя печать, копирование, сканирование и работа с факсами'},
            {printType: 'Высокоскоростная печать (30 стр/мин) в цветном и черно-белом режимах(на листах формата A4)'},
            {printType: 'Цветной сенсорный ЖК-дисплей диагональю 12,3 см'},
            {printType: 'В принтер можно загрузить 800 листов бумаги'},
            {printType: 'Работа через Wi-Fi и проводную сеть'},
            {printType: 'Оригинальные тонер-картриджи сверхвысокой емкости (входящие в комплект поставкитонер-картриджи на 6000 страниц)'},
            {printType: 'Подключение через Интернет'},
